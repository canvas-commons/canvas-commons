...
import colorSource from '!!raw-loader!@canvas-commons/examples/src/scenes/tweening-color';
import cubicSource from '!!raw-loader!@canvas-commons/examples/src/scenes/tweening-cubic';
...
import vectorSource from '!!raw-loader!@canvas-commons/examples/src/scenes/tweening-vector';
import visualiserSource from '!!raw-loader!@canvas-commons/examples/src/scenes/tweening-visualiser';
...
<Fiddle width={'1920'}>{linearSource}</Fiddle>
...
<Fiddle mode="preview" width={'1920'}>
  {cubicSource}
</Fiddle>
...
<Fiddle mode="preview" ratio={'1.9'} width={'1920'}>
  {visualiserSource}
</Fiddle>
...
<Fiddle mode="preview" ratio={'2.8'} width={'1920'}>
  {vectorSource}
</Fiddle>
...
<Fiddle width={'1920'}>{springSource}</Fiddle>
