...
However, if you want to directly produce a finished video, keep the _Video
(WebCodecs)_ exporter selected. It encodes the video in your browser. The
[_Video (FFmpeg)_](/docs/rendering/video) exporter is deprecated. Don't worry,
you can select multiple exporters, and you can always
